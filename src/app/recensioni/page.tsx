    ...
    <div className="bg-warm-white min-h-screen">
        ...
        <div className="max-w-6xl mx-auto pt-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Stars count={5} />
              <div className="font-body text-[10px] tracking-[0.2em] uppercase text-mid-grey">
                Su AutoScout24
              </div>
              {/* Barra percentuale */}
              ...
              <span className="font-body text-[9px] text-mid-grey tracking-wider">
                recensioni positive
              </span>
            </div>
          </div>
      ...
      <div className="bg-[#131313] py-5 px-8">
        <div className="max-w-6xl mx-auto flex flex-wrap items-center gap-3">
          <span className="font-body text-[9px] tracking-[0.2em] uppercase text-mid-grey mr-2">
            Cosa emerge:
          </span>
          {paroleChiave.map((p) => (
            <span
              key={p}
              className="font-body text-[9px] tracking-[0.15em] uppercase text-[#5A5A5A] border border-[0.5px] border-dark-graphite px-3 py-1"
            >
              {p}
            </span>
          ))}
